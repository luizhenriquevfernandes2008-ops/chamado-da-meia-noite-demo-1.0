...
export class TitleMenu {
  ...
  _items() {
    ...
    // Os tres capitulos ja nascem liberados. Nao ha nada a destravar, e
    // travar conteudo num jogo que ainda esta sendo feito so atrapalha quem
    // esta fazendo.
    list.push({ k: 'menu_chapters', a: 'chapters' });
